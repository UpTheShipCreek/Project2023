...
int main(void){
    ...
    std::advance(endIter, std::min(30000, static_cast<int>(images.size())));
    ...
    do{
        ...
        double tA = approxSum / (numberOfQueries);
        double tE = exhaustSum / (numberOfQueries);
        printf("I: %d MaxFactor: %f ApproxAverage: %f ExhaustAverage: %f\n",I, maxFactor, tA / billion, tE / billion);
