...
class Autoencoder(Model):
    def __init__(self, encoding_dimension):
        ...
        self.encoder = tf.keras.Sequential([
            ...
            layers.Conv2D(92, (3, 3), activation='relu', padding='same', activity_regularizer=tf.keras.regularizers.l1(1e-5)),
            layers.MaxPooling2D((2, 2), padding='same'),
            layers.Conv2D(encoding_dimension, (3, 3), activation='relu', padding='same', activity_regularizer=tf.keras.regularizers.l1(1e-5)),
            layers.Flatten(),
